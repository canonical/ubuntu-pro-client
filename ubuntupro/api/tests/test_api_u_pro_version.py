...
from ubuntupro.api.u.pro.version.v1 import (
    VersionError,
    VersionResult,
    _version,
)
...
class TestVersionV1:
    @mock.patch(
        "ubuntupro.api.u.pro.version.v1.get_version", return_value="28"
    )
    ...
    @mock.patch("ubuntupro.api.u.pro.version.v1.get_version")
