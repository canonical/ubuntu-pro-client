...
class TestDetachV1:
    ...
    def test_detach_when_unattached(self, m_is_attached):
    ...
    def test_detach_when_non_root(self, m_we_are_currently_root):
    ...
    def test_detach(
        ...
        assert 1 == m_status_cache_delete.call_count
        assert 1 == m_cfg.delete_cache.call_count
