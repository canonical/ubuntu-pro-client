...
class TestCommonCriteriaEntitlementEnable:
    ...
    # Parameterize True/False for apt_transport_https and ca_certificates
    @pytest.mark.parametrize(
    ...
    def test_enable_configures_apt_sources_and_auth_files(
        ...
        assert (expected_stdout, "") == (stdout, stderr)
    ...
    def test_post_enable_installs_pkgs(
        ...
        assert 0 == m_apt_cache_policy.call_count
        assert [] == m_apt_cache_policy.call_args_list
        assert subp_apt_cmds == m_subp.call_args_list
        expected_stdout = "\n".join(
            [
