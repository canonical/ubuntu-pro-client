...
class TestUAContractClient:
    ...
    def test_get_updated_contract_info(
        ...
        request_url.return_value = (machine_token, {})
        m_contract_update_info.return_value = machine_token
        kwargs = {
        ...
        assert [mock.call(**kwargs)] == m_contract_update_info.call_args_list
...
class TestContractChanged:
    ...
    def test_contract_change_with_expiry(
        self, get_updated_contract_info, is_expired, FakeConfig
    ):
        if is_expired:
    ...
    @pytest.mark.parametrize("ent_changed", (False, True))
    def test_contract_change_with_entitlements(
        self, get_updated_contract_info, ent_changed, FakeConfig
    ):
        if ent_changed:
