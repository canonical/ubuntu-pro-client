Feature: Command behaviour when attached to an Ubuntu Pro subscription
  ...
  Scenario Outline: Run collect-logs on an attached machine
    ...
    Then stdout contains substring:
      """
      [WARNING] *Your Ubuntu Pro subscription has EXPIRED*
      Renew your subscription at https://ubuntu.com/pro/dashboard
      """
    ...
    Then stdout contains substring:
      ...
      The following packages will fail to download because your Ubuntu Pro subscription has expired
        hello
      Renew your {account_name} subscription or `sudo pro detach` to remove these errors
      """
    And sterr matches regexp:
      """
    ...
    Then stdout contains substring:
      """
      *Your Ubuntu Pro subscription has EXPIRED*
      2 additional security updates require Ubuntu Pro with 'esm-apps' enabled.
      Renew your subscription at https://ubuntu.com/pro/dashboard
      """
