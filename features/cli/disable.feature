Feature: CLI disable command
  ...
  Scenario Outline: Disable and purge fips
    ...
    Examples: ubuntu release
      ...
      | focal   | lxd-vm        | fips         | FIPS         | linux-fips       | https://esm.ubuntu.com/fips/ubuntu focal/main                  | https://esm.ubuntu.com/infra/ubuntu focal-infra-security/main  |
      | focal   | lxd-vm        | fips-updates | FIPS Updates | linux-fips       | https://esm.ubuntu.com/fips-updates/ubuntu focal-updates/main  | https://esm.ubuntu.com/infra/ubuntu focal-infra-security/main  |
      | focal   | aws.generic   | fips         | FIPS         | linux-aws-fips   | https://esm.ubuntu.com/fips/ubuntu focal/main                  | https://esm.ubuntu.com/infra/ubuntu focal-infra-security/main  |
      | focal   | aws.generic   | fips-updates | FIPS Updates | linux-aws-fips   | https://esm.ubuntu.com/fips-updates/ubuntu focal-updates/main  | https://esm.ubuntu.com/infra/ubuntu focal-infra-security/main  |
      | focal   | azure.generic | fips         | FIPS         | linux-azure-fips | https://esm.ubuntu.com/fips/ubuntu focal/main                  | https://esm.ubuntu.com/infra/ubuntu focal-infra-security/main  |
      | focal   | azure.generic | fips-updates | FIPS Updates | linux-azure-fips | https://esm.ubuntu.com/fips-updates/ubuntu focal-updates/main  | https://esm.ubuntu.com/infra/ubuntu focal-infra-security/main  |
      | focal   | gcp.generic   | fips         | FIPS         | linux-gcp-fips   | https://esm.ubuntu.com/fips/ubuntu focal/main                  | https://esm.ubuntu.com/infra/ubuntu focal-infra-security/main  |
      | focal   | gcp.generic   | fips-updates | FIPS Updates | linux-gcp-fips   | https://esm.ubuntu.com/fips-updates/ubuntu focal-updates/main  | https://esm.ubuntu.com/infra/ubuntu focal-infra-security/main  |
