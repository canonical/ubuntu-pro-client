Feature: Fix plan API endpoints
    ...
    Scenario Outline: Fix command on an unattached machine
        ...
        And stdout matches regexp:
        """
        {"_schema_version": "v1", "data": {"attributes": {"cves_data": {"cves": \[{"additional_data": {}, "affected_packages": \["squid3"\], "description": ".*", "error": null, "expected_status": "still-affected", "plan": \[{"data": {"binary_packages": \[\], "pocket": "Ubuntu standard updates", "source_packages": \["squid3"\]}, "operation": "apt-upgrade", "order": 3}\], "title": "CVE-2020-25097", "warnings": \[{"data": {"binary_package": "squid", "binary_package_version": "3.5.12-1ubuntu7.16", "pocket": "Ubuntu standard updates", "source_package": "squid3"}, "order": 1, "warning_type": "package-cannot-be-installed"}, {"data": {"binary_package": "squid-common", "binary_package_version": "3.5.12-1ubuntu7.16", "pocket": "Ubuntu standard updates", "source_package": "squid3"}, "order": 2, "warning_type": "package-cannot-be-installed"}\]}\], "expected_status": "still-affected"}}, "meta": {"environment_vars": \[\]}, "type": "CVEFixPlan"}, "errors": \[\], "result": "success", "version": ".*", "warnings": \[\]}
        """
