Feature: Fix plan API endpoints
    ...
    Scenario Outline: Fix command on an unattached machine
        ...
        And stdout matches regexp:
        """
        {"_schema_version": "v1", "data": {"attributes": {"cves_data": {"cves": \[{"additional_data": {}, "affected_packages": \["krb5"\], "description": ".*", "error": null, "expected_status": "fixed", "plan": \[{"data": {"status": "cve-already-fixed"}, "operation": "no-op", "order": 1}\], "title": "CVE-2020-28196", "warnings": \[\]}, {"additional_data": {}, "affected_packages": \[\], "description": ".*", "error": null, "expected_status": "not-affected", "plan": \[{"data": {"status": "system-not-affected"}, "operation": "no-op", "order": 1}\], "title": "CVE-2020-15180", "warnings": \[\]}, {"additional_data": {}, "affected_packages": \["expat", "matanza", "swish-e"\], "description": ".*", "error": null, "expected_status": "still\-affected", "plan": \[{"data": {"binary_packages": \["expat"\], "pocket": "Ubuntu standard updates", "source_packages": \["expat"\]}, "operation": "apt-upgrade", "order": 2}\], "title": "CVE-2017-9233", "warnings": \[{"data": {"source_packages": \["matanza", "swish\-e"\], "status": "needs-triage"}, "order": 1, "warning_type": "security\-issue-not\-fixed"}\]}\], "expected_status": "still\-affected"}}, "meta": {"environment_vars": \[\]}, "type": "CVEFixPlan"}, "errors": \[\], "result": "success", "version": ".*", "warnings": \[\]}
        """
        ...
        And stdout matches regexp:
        """
        {"_schema_version": "v1", "data": {"attributes": {"usns_data": {"expected_status": "fixed", "usns": \[{"related_usns_plan": \[{"additional_data": {"associated_cves": \["CVE-2022-1271"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \[\], "description": ".*", "error": null, "expected_status": "not-affected", "plan": \[{"data": {"status": "system-not-affected"}, "operation": "no-op", "order": 1}\], "title": "USN-5378-1", "warnings": \[\]}, {"additional_data": {"associated_cves": \["CVE-2022-1271"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \[\], "description": ".*", "error": null, "expected_status": "not-affected", "plan": \[{"data": {"status": "system-not-affected"}, "operation": "no-op", "order": 1}\], "title": "USN-5378-2", "warnings": \[\]}, {"additional_data": {"associated_cves": \["CVE-2022-1271"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \["xz-utils"\], "description": ".*", "error": null, "expected_status": "fixed", "plan": \[{"data": {"reason": "required-pro-service"}, "operation": "attach", "order": 1}, {"data": {"service": "esm-infra"}, "operation": "enable", "order": 2}, {"data": {"binary_packages": \["liblzma5", "xz-utils"\], "pocket": "Ubuntu Pro: ESM Infra", "source_packages": \["xz-utils"\]}, "operation": "apt-upgrade", "order": 3}\], "title": "USN-5378-3", "warnings": \[\]}], "target_usn_plan": {"additional_data": {"associated_cves": \["CVE-2022-1271"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \["gzip"\], "description": ".*", "error": null, "expected_status": "fixed", "plan": \[{"data": {"reason": "required-pro-service"}, "operation": "attach", "order": 1}, {"data": {"service": "esm-infra"}, "operation": "enable", "order": 2}, {"data": {"binary_packages": \["gzip"\], "pocket": "Ubuntu Pro: ESM Infra", "source_packages": \["gzip"\]}, "operation": "apt-upgrade", "order": 3}\], "title": "USN-5378-4", "warnings": \[\]}}\]}}, "meta": {"environment_vars": \[\]}, "type": "USNFixPlan"}, "errors": \[\], "result": "success", "version": ".*", "warnings": \[\]}
        """
        ...
        And stdout matches regexp:
        """
        {"_schema_version": "v1", "data": {"attributes": {"usns_data": {"expected_status": "fixed", "usns": \[{"related_usns_plan": \[{"additional_data": {"associated_cves": \["CVE-2021-3711", "CVE-2021-3712"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \[\], "description": ".*", "error": null, "expected_status": "not-affected", "plan": \[{"data": {"status": "system-not-affected"}, "operation": "no-op", "order": 1}\], "title": "USN-5051-1", "warnings": \[\]}, {"additional_data": {"associated_cves": \["CVE-2021-3712"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \[\], "description": ".*", "error": null, "expected_status": "not-affected", "plan": \[{"data": {"status": "system-not-affected"}, "operation": "no-op", "order": 1}\], "title": "USN-5051-3", "warnings": \[\]}, {"additional_data": {"associated_cves": \["CVE-2019-11098", "CVE-2021-3712", "CVE-2021-23840", "CVE-2021-38575"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \[\], "description": ".*", "error": null, "expected_status": "not-affected", "plan": \[{"data": {"status": "system-not-affected"}, "operation": "no-op", "order": 1}\], "title": "USN-5088-1", "warnings": \[\]}\], "target_usn_plan": {"additional_data": {"associated_cves": \["CVE-2021-3712"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \["openssl"\], "description": ".*", "error": null, "expected_status": "fixed", "plan": \[{"data": {"reason": "required-pro-service"}, "operation": "attach", "order": 1}, {"data": {"service": "esm-infra"}, "operation": "enable", "order": 2}, {"data": {"binary_packages": \["libssl1.0.0", "openssl"\], "pocket": "Ubuntu Pro: ESM Infra", "source_packages": \["openssl"\]}, "operation": "apt-upgrade", "order": 3}\], "title": "USN-5051-2", "warnings": \[\]}}, {"related_usns_plan": \[{"additional_data": {"associated_cves": \["CVE-2022-1271"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \[\], "description": ".*", "error": null, "expected_status": "not-affected", "plan": \[{"data": {"status": "system-not-affected"}, "operation": "no-op", "order": 1}\], "title": "USN-5378-1", "warnings": \[\]}, {"additional_data": {"associated_cves": \["CVE-2022-1271"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \[\], "description": ".*", "error": null, "expected_status": "not-affected", "plan": \[{"data": {"status": "system-not-affected"}, "operation": "no-op", "order": 1}\], "title": "USN-5378-2", "warnings": \[\]}, {"additional_data": {"associated_cves": \["CVE-2022-1271"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \["xz-utils"\], "description": ".*", "error": null, "expected_status": "fixed", "plan": \[{"data": {"reason": "required-pro-service"}, "operation": "attach", "order": 1}, {"data": {"service": "esm-infra"}, "operation": "enable", "order": 2}, {"data": {"binary_packages": \["liblzma5", "xz-utils"\], "pocket": "Ubuntu Pro: ESM Infra", "source_packages": \["xz-utils"\]}, "operation": "apt-upgrade", "order": 3}\], "title": "USN-5378-3", "warnings": \[\]}\], "target_usn_plan": {"additional_data": {"associated_cves": \["CVE-2022-1271"\], "associated_launchpad_bugs": \[\]}, "affected_packages": \["gzip"\], "description": ".*", "error": null, "expected_status": "fixed", "plan": \[{"data": {"reason": "required-pro-service"}, "operation": "attach", "order": 1}, {"data": {"service": "esm-infra"}, "operation": "enable", "order": 2}, {"data": {"binary_packages": \["gzip"\], "pocket": "Ubuntu Pro: ESM Infra", "source_packages": \["gzip"\]}, "operation": "apt-upgrade", "order": 3}\], "title": "USN-5378-4", "warnings": \[\]}}\]}}, "meta": {"environment_vars": \[\]}, "type": "USNFixPlan"}, "errors": \[\], "result": "success", "version": ".*", "warnings": \[\]}
        """
